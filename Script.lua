...
local function ApplyPotatoGraphics()
    ...
    task.defer(function()
        local ok, errorMessage = pcall(function()
            ...
            -- O Potato processa somente o mapa e a iluminação. Evitar
            -- game:GetDescendants impede que CoreGui/Players aumentem o pico.
            local descendants = workspace:GetDescendants()
            for _, object in ipairs(lighting:GetDescendants()) do
                table.insert(descendants, object)
            end

            -- Lotes menores reduzem o travamento inicial e os spikes de frame.
            for _, object in ipairs(descendants) do
                ...
                started = YieldWithinBudget(started, 0.0008)
            end
        end)
